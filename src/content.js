        ...
        content: [
            {
                type: '',
                text:
                    `תחום המשפט הפלילי עוסק בחקירה והעמדה לדין בגין עבירות פליליות. חשוב לדעת שההליך הפלילי מתחלק למספר שלבים שכל אחד מהם עומד בפני עצמו ודורש מומחיות נפרדת, שכן ניהול נכון של כל אחד מהם יכול להוביל לסגירת החקירה, סגירת התיק הפלילי ולזיכוי.`,
    ...
    about: {
        content: [
            ...
            // },
            {
                type: 'imagecaption',
                image: {
                    source: { uri: ABOUT_PHOTO_URI },style:{ width: 300, height: 500}
                },
                content: [
                    ...
                    `המשרד מספק ייעוץ משפטי וייצוג בכל סוגי העבירות הפליליות ובפני כל הערכאות השיפוטיות, לרבות בית משפט השלום, בית משפט לעניינים מקומיים, בית דין צבאי, בית משפט מחוזי ובית המשפט העליון.`,
                    `המשרד מלווה את לקוחותיו בכל שלבי ההליך הפלילי, החל מייעוץ לפני ובמהלך החקירה, ייצוג בהליכי מעצר, שימוע לפני הגשת כתבי אישום, בקשות לביטול הליכים, הסדרים מותנים והסדרי טיעון, ניהול הוכחות וחקירת עדים, טיעונים לעונש וערעורים. כמו כן, עוסק המשרד גם בהליכים שלאחר סיום התיק הפלילי, כגון ייצוג בועדות לעיון בעונש, עתירות אסירים, בקשות חנינה וכדומה.`
                ]
            },
            {
                type: 'underline',
            ...
            {
                type: 'imagecaption',
                image: { source: { uri: IMAGE_2_URI },style:{ width: 300, height: 500}},
                content: [
